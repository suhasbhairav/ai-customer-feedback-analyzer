  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f0fdf4] text-[#07160c]">
      <section className="mx-auto min-h-screen max-w-[1450px] px-4 py-6 sm:px-6 lg:px-8">
        <header className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between"><div><p className="text-xs font-black uppercase opacity-50">Insight console</p><h1 className="mt-3 text-4xl font-black sm:text-6xl">AI Customer Feedback Analyzer</h1></div><p className="max-w-xl leading-7 opacity-65">A customer feedback analyzer starter for theme extraction, sentiment, and roadmap signals.</p></header>
