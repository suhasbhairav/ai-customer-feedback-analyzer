...
const SYSTEM_PROMPT = `
You are AI Customer Feedback Analyzer, a focused AI starter template.
...
function offlineResult(prompt) {
  return `
AI Customer Feedback Analyzer offline demo

User input:
${prompt}

Structured output:
1. Goal: Turn the request into a production-ready ai analysis template workflow.
